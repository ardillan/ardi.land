...
Así es, estreno blog con una nueva tecnología: **Jekyll**. Una plataforma de *blogging* la cual es capaz de generar un pequeño *site* sin la necesidad de base de datos. Los post están escritos en [Markdown](https://es.wikipedia.org/wiki/Markdown) y la navegación por la web es bastante rápida.
